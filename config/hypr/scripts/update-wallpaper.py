...
FILE_PATH = "/home/barucco/lock-wallpaper.png"
META_URL = "https://www.bing.com/HPImageArchive.aspx?format=js&idx=0&n=1&mkt=pt-BR"
...
# Set Wallpaper
cmd = f"sleep 1; swaybg -m fill -i {FILE_PATH} &"
os.system(cmd)
